...
class Application(SQLModel, table=True):
    ...
    name: str = Field(nullable=False, max_length=63, description="应用名称")
    description: str = Field(nullable=False, max_length=255, description="应用描述")
    icon: str = Field(nullable=False, max_length=63, description="应用图标")
    model_name: str = Field(nullable=False, max_length=128, description="模型标识")
