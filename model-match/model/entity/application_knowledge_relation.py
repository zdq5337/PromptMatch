...
class ApplicationKnowledgeRelation(SQLModel, table=True):
    # 指定数据库表的名称
    __tablename__ = "application_knowledge_relation"

    id: Optional[int] = Field(default=None, primary_key=True, sa_column_kwargs={"autoincrement": True}, description="主键id")
    application_id: int = Field(nullable=False, description="应用id")
